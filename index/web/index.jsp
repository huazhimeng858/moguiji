...
<html>
  ...
  <section class="banner fusion-slider" id="fusion-main-text">
    ...
    <div class="container fusion-slider-container text-center">
      <div class="fusion-margin-top">
        ...
        <div class="fusion-slider-button title-master"><a href="#main"><span>继续&nbsp;</span><span class="fa fa-angle-down"></span></a></div>
      </div>
    </div>
  </section>
  <section class="fusion-position" id="main">
    <div class="container">
      ...
      <div class="fusion-know">
        <div class="row">
          <div class="col-lg-4 col-lg-offset-4">
            <div class="fusion-position-btn"><a href=""><span>了解更多</span><i class="fa fa-angle-double-right"></i></a></div>
          </div>
          <div class="col-lg-8 col-md-12 col-lg-offset-2 fusion-position-example">
            ...
            <div class="author" style="color:#747474;">
              <span class="author-icon fa fa-user pull-left fa-2x"></span>
              <span class="company-name">H.L.&nbsp;Chao,&nbsp;Lenovo中国总部OA部门</span>
            </div>
          </div>
          <div class="col-lg-8 col-md-12 col-lg-offset-2">
            <div class="pull-right fusion-reference-text"><a href="">参考案例<span class="fa fa-angle-double-right"></span></a></div>
          </div>
          <div class="col-lg-8 col-md-12 col-lg-offset-2">
            <hr>
          </div>
